...
import com.hye.generics.typeinference.Box;
...
public class Main {
    ...
    public static void main(String[] args) {
    	// <> : 다이아몬드..타입 아규먼트를 지정해야 하는 곳
    	//		컴파일러가 코드 문맥을 보고 타입 아규먼트를 추론(Inference)하기에
    	//		new 이하 코드의 <> 안에 타입 아규먼트를 비워놔도 문제 없음.
...
//        main.processNumbers(strList);
        ...
        */        
        ...
        List<Integer> li2 = Arrays.asList(1, 2, 3, 4);
