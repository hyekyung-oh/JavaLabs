package com.hye.generics.wildcards.relation;
...
public class Main {
    public static void main(String[] args) {
    	...
    	// List<Integer>는 integerList 참조 변수의 데이터 타입 : 타입 아규먼트가 Integer인 제너릭 인터페이스 구현체
        ...
        // Integer를 상속한 하위 클래스들 중에 하나가 타입 아규먼트가 될 수 있는 엘리먼트를 가지는 리스트?
        // List<? extends Integer> : 파라미터화된 타입 / intList : 참조변수
