...
import com.hye.generics.typeinference.Converter;
...
public class Box<T> {
    ...
    public <U> Box(U input, Converter<U, T> converter) {
    	// 만약 converter의 구현체가 Object.toString이라면,
    	// (실제, Double.toString이 호출됨: U가 Double 이기 때문에!!!)
    	// 이 toString 메서드는 Double의 field인 value[데이터 타입은 double] 값에
    	// 해당하는 문자열을 리턴함...
