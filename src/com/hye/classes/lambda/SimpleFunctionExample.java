...
public class SimpleFunctionExample {
    ...
    public static void main(String[] args) {
        ...
        // 		return e.getAge();
        //	 }
//        Function<Employee, Integer> ageExtractor = e -> e.getAge();
        
        Function<Employee, Integer> ageExtractor = e -> {      	
        	 return e.getAge();
        	};               
...
//        Function<Employee, String> nameExtractor = e -> e.getName();
    	Function<Employee, String> nameExtractor = e -> {      	
       	 	return e.getName();
       	};       
        //Function<Employee, Integer> ageExtractor = (Employee e) -> e.getName();
        ...
        //	 }
//        Function<Employee, String> deptExtractor = e -> e.getDepartment();
    	Function<Employee, String> deptExtractor = e -> {      	
       	 	return e.getDepartment();
       	};      
        //Function<Employee, Integer> ageExtractor = (Employee e) -> e.getDepartment();
