...
// 함수형 인터페이스(Functional Interface) : 가상 메서드가 하나만 선언되어 있는 인터페이스
public interface OnlyOneAMethodInterface {
	...
	public void check(); // 이 인터페이스에서 가상 메서드 선언은 오로지 하나!!
...
/*	public int add(int a, int b) {
	...
	// OnlyOneAMethodInterface oooi = (a, b) -> a+b / 2;
	 
	/*  OnlyOneAMethodInterface oooi = (a, b) -> {
	   	int temp = a + b;
	   	int ret = temp / 2;
	    return ret;
	}*/
