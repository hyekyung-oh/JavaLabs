package com.hye.interfaces.ploymorphism.equivalency;
...
//		Book firstBook  = new Book(new String("0201914670"));
		Book firstBook  = new Book("0201914670");
		Book secondBook = new Book("0201914670");
		// Book 클래스의 equals(Object 클래스의 equals를 오버라이드한 메서드) 
		// 메서드를 호출함
	...
	public static void checkEqual() {
		...
		// 즉, 아직 Book 클래스에 equals을 오버라이드 하지 않았음.
