...
//		String str = "Hello";
		/*
		 static Integer valueOf(int i) : AutoBoxing이라 함!!
		 */
		// 컴파일러가 컴파일할 때, 대입 연산자를 통해 3이라는 정수 리터럴을 대입하는
		...
		Double doubleValue = 3.0d; // private final double value;
