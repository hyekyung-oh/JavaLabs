...
//		byte byteDataType = 0b0111_1111; // byte 데이터 타입의 최대 양수 값
		// 위 값 0b0111_1111(십진수: 127)을 2의 보수로 음수(단, 이진수로)로 나타낸다면? 
		// ...0b1000_0001(십진수:-127)
		...
		int maxOfIntDataType = 0x7FFF_FFFF;
		System.out.printf("0x%x \n", maxOfIntDataType);
		
		// 32 비트로 가장 큰 양수는 +2147483647[십진수] : 
		// 음수에 비해 1 작은 이유: 0이 포함되었기 때문에...
		//					  단, 하나의 0만 존재(+0)
		
		// 32 비트로 가장 작은 음수는 -2147483648[십진수]
		int minOfIntDataType = -2147483648; // 0x8000_000;	
		...
		Class<String> stringClass = String.class; // 'String.class'라는 특별한 리터렁
